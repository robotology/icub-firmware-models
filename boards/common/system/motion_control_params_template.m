...
function MotionControlInitConf = motion_control_params_template
    ...
    MotionControlInitConf.motor.externals.enable_verbosity = false;
    MotionControlInitConf.motor.externals.has_hall_sens = true;
    MotionControlInitConf.motor.externals.has_quadrature_encoder = false;
    MotionControlInitConf.motor.externals.has_speed_quadrature_encoder = false;
    MotionControlInitConf.motor.externals.has_temperature_sens = false;
    MotionControlInitConf.motor.externals.encoder_tolerance = uint8(0);
    MotionControlInitConf.motor.externals.pole_pairs = uint8(7);
    MotionControlInitConf.motor.externals.rotor_encoder_resolution = int16(0);
    MotionControlInitConf.motor.externals.rotor_index_offset = int16(0);
    MotionControlInitConf.motor.externals.use_index = false;    
